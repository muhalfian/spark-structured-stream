...
private[spark] object DatasetUtils {
   ...
   */
  override def columnToVector(dataset: Dataset[_], colName: String): Column = {
      ...
      case fdt: ArrayType =>
        val transferUDF = fdt.elementType match {
          case _: FloatType => udf(f = (vector: Seq[Float]) => {
            ...
            val inputArray = Array.fill[Double](40000)(0.0)
  ...
  override def columnToOldVector(dataset: Dataset[_], colName: String): RDD[OldVector] = {
